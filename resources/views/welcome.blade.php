  ...
  <main class="main">
    ...
    <section id="about" class="about section">
      ...
      <div class="container section-title" data-aos="fade-up">
        ...
        <h2>Tentang Aplikasi M-Tugas</h2>
        <p>M-Tugas Merupakah Sebuah Aplikasi Manajemen Tugas Berbasis Website</p>
      ...
      <div class="container">
        ...
        <div class="row gy-4">
          ...
          <div class="col-xl-12 content" data-aos="fade-up" data-aos-delay="200">
            <h3>Lebih Lanjut Mengenai Aplikasi M-Tugas</h3>
            <p class="fst-italic">
              Berikut Adalah Spesifikasi Aplikasi M-Tugas
            </p>
            <ul>
